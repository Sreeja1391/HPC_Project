...
for track_uri in merged_data[merged_data['genre_query_tag'] == genre_name]['track_uri']:
...
# full_path = "/home/nchunduru/project/STAT605-Project/corr_outputs"
...
heatmapplot = sns.heatmap(corr, mask=mask, cmap=cmap, vmax=.3, center=0,
...
# plt.show()
img_path = os.path.join(f'coefficient_plot_{genre_name}.png')
# plt.savefig(img_path, bbox_inches="tight")
heatmapplot.figure.savefig(img_path)
# plt.close()
